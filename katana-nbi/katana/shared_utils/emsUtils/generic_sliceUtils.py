...
class SliceAdapterClient:
    """
    Client for Katana slice adapters.

    Any RAN, CORE, transport, or lab-specific adapter can be used if it exposes
    POST /slice and DELETE /slice/<slice_id>.
    """
    ...
    def health(self, url):
        return self._request("get", url, "/health")
    ...
    def _request(self, method, base_url, path, payload=None):
        ...
        try:
            ...
            logger.exception("Slice adapter request failed")
